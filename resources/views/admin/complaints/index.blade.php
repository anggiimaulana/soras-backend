...
@section('content')
    <div class="space-y-5">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            ...
            Skala: <strong class="text-gray-700 dark:text-gray-300">-0.5</strong> (berisiko) hingga
            <strong class="text-gray-700 dark:text-gray-300">1.0</strong> (sangat cocok).
        </p>
        ...
        <div
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-white/[0.03] border-b border-gray-100 dark:border-white/[0.07]">
                    <tr>
                        <th class="text-left px-4 py-3.5 font-medium text-gray-500 dark:text-gray-400 min-w-40">Keluhan</th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-white/[0.05]">
                    @foreach ($complaints as $complaint)
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                            <td class="px-4 py-3 font-semibold text-gray-800 dark:text-gray-200">{{ $complaint->name }}</td>
                            @foreach ($exercises as $exercise)
                                @php
        ...
        <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span class="flex items-center gap-1.5"><span class="w-3 h-3 bg-blue-200 dark:bg-blue-500/30 rounded"></span> ≥
                0.3 Netral</span>
            <span class="flex items-center gap-1.5"><span class="w-3 h-3 bg-gray-200 dark:bg-white/10 rounded"></span> ≥ 0
                Tidak Direkomendasikan</span>
            <span class="flex items-center gap-1.5"><span class="w-3 h-3 bg-red-200 dark:bg-red-500/30 rounded"></span> &lt;
                0 Berisiko</span>
        </div>
